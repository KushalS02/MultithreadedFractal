/* modified from: https://github.com/marc-q/libbmp/
...
bmp_img_alloc (bmp_img *img)
{
	...
	{
		//img->img_pixels[y] = malloc (sizeof (bmp_pixel) * img->img_header.biWidth); modified to work with memory mapping
        img->img_pixels[y] =  (sizeof (bmp_pixel) * img->img_header.biWidth);
	}
}
